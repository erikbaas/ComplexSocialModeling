...
class Sugarscape(Matrix):
    ...
    def __init__(self, num_agents = 500, max_sugar=5, sugar_growth_rate=1,
                 agent_vision=3, agent_metabolism=4, tax_rate=0.5):
        ''' The sugarscape is a matrix of Location objects.'''
        Matrix.__init__(self, 50, 50)
    ...
    def populate_sugarscape(self):
        ...
        for x in range(self.length):
            for y in range(self.width):
                ...
                loc.set_max_sugar(self.map[map_i])
                loc.set_sugar_amt(self.map[map_i])
    ...
    def nextstep(self):
        ...
        #             self.get_location(x, y).set_sugar_growth_rate(0)
        #     for x in xrange((self.length*2/3),self.length):
        #         for y in xrange(0,(self.width/3)):
        #             self.get_location(x, y).set_sugar_growth_rate(1)
